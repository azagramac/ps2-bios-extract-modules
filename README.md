...
1. Place your BIOS files in the same folder as the script. Supported extensions:  
...
Each BIOS file with a ROMDIR will have its modules extracted into a subfolder named modules-<filename>.

A Markdown file bios_modules.md will be generated with:
  - MD5 and size of each input BIOS file.
  - A list of extracted modules per BIOS file, including original size and MD5.

### Notes
- Modules are extracted exactly as they are in the BIOS, with no padding.

### Copyright Notice
For copyright reasons, the BIOS must be extracted by yourself.
For example, you can use [biosdrain](https://github.com/F0bes/biosdrain) to dump your own PS2 BIOS from the console.
...
## 📂 Modules from SCPH-39004.mec

| # | Module | Size (bytes) | MD5 |
|---|--------|--------------|-----|

## 📂 Modules from SCPH-39004.nvm
